    ...
    <div name="home" className='h-screen w-full bg-gradient-to-b from-black via-black to-gray-800 '>
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row '>
            <div className='flex flex-col justify-center h-full my-6'>
                <h2 className='text-4xl sm:text-7xl font-bold text-yellow-50 justify-center px-6 my-6'> A Data vigilante</h2>
            ...
            <div className='my-23'>
                <img src={HeroImage} alt='my Profile' className='rounded-2xl ml-auto mx-auto h-auto w-2/3 md:w-full'></img>
            </div>
        </div>
